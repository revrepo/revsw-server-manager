...
testCommands=(
     ...
     "sudo /usr/lib/nagios/plugins/check_http -I localhost -u http://cdn.mbeans2.com/images/billboards/Home/main/2015-uppababy-billboard-full.jpg -e 200"
     "sudo /usr/lib/nagios/plugins/check_http -I localhost -u http://mbeans.com/ -e 200"
     "sudo /usr/lib/nagios/plugins/check_http -I localhost -u http://www.revsw.com/ -e 301"
     "sudo /usr/lib/nagios/plugins/check_http -I localhost -u http://cdn.turbonomic.com/wp-content/plugins/wp-views/embedded/res/css/wpv-pagination.css -e 200"
     "sudo /usr/lib/nagios/plugins/check_http -I localhost -u http://m.jisusaiche.com/js/fz-1.3.6-min.js -e 200"
     ...
     "sudo /usr/lib/nagios/plugins/check_http -I localhost -u https://www.revapm.com/ --ssl -e 200"
